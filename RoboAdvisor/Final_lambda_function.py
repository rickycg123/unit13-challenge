...
def recommend_portfolio(intent_request):
    ...
    risk_level = get_slots(intent_request)["riskLevels"]
...
def get_investment_recommendation(risk_level):
    ...
    return risk_level_dict[risk_level.lower()]
    ...
    if age is not None:
        ...
        if age < 0:
            ...
            return build_validation_result(
                False,
                "age",
                "Your age cannot be negative to use this service, "
                "please provide a different age.",
                )
    ...
    if investment_amount is not None:
        ...
        if investment_amount <= 5000:
            return build_validation_result(
                ...
                "please provide a new amount in USD to invest.",
            )
